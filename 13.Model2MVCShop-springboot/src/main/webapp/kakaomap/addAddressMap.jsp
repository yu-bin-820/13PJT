...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=613cadbd7689ec87a665bc72b8459615&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
...
function displayPlaces(places) {
    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        (function(marker, title, address, lat, lng) {
